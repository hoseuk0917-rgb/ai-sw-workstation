...
|------|------|
| 주관 | (재)이노베이션아카데미 |
| 교육기간 | 총 6개월 (모집/선발 1개월 + 학습/Term-Project 5개월) |
| 선발 과정 | 2025.7.11(금)~7.25(금), 200명 |
| 혁신교육과정 | 2025.8.1(금)~12.31(수), 100명 내외 선발 |
| 교육비 | 전액 무료, 교육장 24시간 개방 |
| 교육장 | 서울시 강남구 개포로 416, 이노베이션아카데미 새롬관 |
| 지원금 | 선발 과정 완주 시 50만원(세전), 혁신교육과정 최대 500만원 |
...
```
교육생 모집/선발 (2주)
    └─ DevOps 기반 기초 PBL (개발 환경 구성, Git)
         │
공통 과정: 디지털 역량 온보딩 (1.5개월)
    └─ Web, DevOps & Python
         │
    ┌────┴────┐
선택 AI 기초     선택 AI 고급
...
| 레포 | 소유자 | 내용 |
|------|--------|------|
| [inka-codyssey](https://github.com/I-nkamanda/inka-codyssey) | I-nkamanda | 메인 과제 레포 (1단원, 5단원, 6단원) |
| [Mars_1](https://github.com/I-nkamanda/Mars_1) | I-nkamanda | 화성 미션 1탄 |
| [Mars-1_2](https://github.com/I-nkamanda/Mars-1_2) | I-nkamanda | 화성 미션 1-2탄 |
| [Mars-2](https://github.com/I-nkamanda/Mars-2) | I-nkamanda | 화성 미션 2탄 (암호, GUI, CCTV) |
| [david](https://github.com/I-nkamanda/david) | I-nkamanda | Flask 웹 앱 (gTTS) |
